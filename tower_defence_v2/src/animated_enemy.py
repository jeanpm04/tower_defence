...
class AnimatedEnemy:
    def __init__(self, path, sprite_sheet_path, frame_width, frame_height, num_frames, health, speed):
        ...
        full_sprite_sheet_path = os.path.join(base_dir, '..', sprite_sheet_path)

        # --- ADD THIS PRINT STATEMENT ---
        print(f"Attempting to load: {full_sprite_sheet_path}")
        # -------------------------------

        self.sprite_sheet = pygame.image.load(full_sprite_sheet_path).convert_alpha()
